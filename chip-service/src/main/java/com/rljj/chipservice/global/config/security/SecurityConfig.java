package com.rljj.chipservice.global.config.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, HttpSession httpSession) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/chip-info").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/chip/post/{chipPostId}").permitAll()
                        .requestMatchers("/api/chip/posts").permitAll()
                        .requestMatchers("/api/chip/exchange/{chipPostId}").permitAll()
